...
import { HYPERLIQUID } from "./commands/hyperliquid";
...
const COMMANDS = ["help", "about", "projects", "whoami", "banner", "clear", "hyperliquid"];
...
function commandHandler(input : string) {
  ...
  switch(input) {
    ...
    case 'hyperliquid':
      if(bareMode) {
        writeLines(["No moola.", "<br>"])
        break;
      }
      writeLines(HYPERLIQUID);
      break;
    ...
    case 'email':
      ...
      writeLines(["arjunsenthil.dev@gmail.com"]);
      break;
    case 'rm -rf':
      if (bareMode) {
